...
def schaffer(p):
    ...
    t_span, *_ = calculate_smoke_valid_duration(drone_speed, theta, t_drop, t_burst, fyx_pos_init=(17800, 0, 1800))

    return - (t_span[1] - t_span[0])

from sko.GA import GA

ga = GA(func=schaffer, n_dim=4, size_pop=70, max_iter=150, prob_mut=0.01, lb=[70, 0, 0, 0], ub=[140, 180, 5, 5], precision=1e-7)
...
plt.ylabel('Best Y')
plt.title('q2:GA Optimization History')
plt.show()